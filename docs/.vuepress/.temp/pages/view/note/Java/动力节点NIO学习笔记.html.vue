<template><h1 id="nio学习笔记" tabindex="-1"><a class="header-anchor" href="#nio学习笔记" aria-hidden="true">#</a> NIO学习笔记</h1>
<h2 id="nio概述" tabindex="-1"><a class="header-anchor" href="#nio概述" aria-hidden="true">#</a> NIO概述</h2>
<h3 id="程序读取数据模型" tabindex="-1"><a class="header-anchor" href="#程序读取数据模型" aria-hidden="true">#</a> 程序读取数据模型</h3>
...
<h3 id="buffer的属性" tabindex="-1"><a class="header-anchor" href="#buffer的属性" aria-hidden="true">#</a> Buffer的属性</h3>
...
<h3 id="buffer的常用api" tabindex="-1"><a class="header-anchor" href="#buffer的常用api" aria-hidden="true">#</a> Buffer的常用API</h3>
...
<h3 id="直接字节缓冲区" tabindex="-1"><a class="header-anchor" href="#直接字节缓冲区" aria-hidden="true">#</a> 直接字节缓冲区</h3>
...
<h2 id="channel-1" tabindex="-1"><a class="header-anchor" href="#channel-1" aria-hidden="true">#</a> Channel</h2>
<h3 id="channels概述" tabindex="-1"><a class="header-anchor" href="#channels概述" aria-hidden="true">#</a> Channels概述</h3>
...
<h3 id="scatter-gather" tabindex="-1"><a class="header-anchor" href="#scatter-gather" aria-hidden="true">#</a> Scatter/Gather</h3>
...
<p>​</p>
<h3 id="filechannel" tabindex="-1"><a class="header-anchor" href="#filechannel" aria-hidden="true">#</a> FileChannel</h3>
...
<h3 id="socketchannel与serversocketchannel" tabindex="-1"><a class="header-anchor" href="#socketchannel与serversocketchannel" aria-hidden="true">#</a> SocketChannel与ServerSocketChannel</h3>
<p>ServerSocketChannel可以监听新进来的TCP连接通道</p>
<p>SocketChannel是一个连接到TCP网络套接字的通道</p>
<h3 id="datagramchannel" tabindex="-1"><a class="header-anchor" href="#datagramchannel" aria-hidden="true">#</a> DataGramChannel</h3>
<p>DatagramChannel是对UDP无连接用户数据报协议的通道</p>
<h3 id="pipe" tabindex="-1"><a class="header-anchor" href="#pipe" aria-hidden="true">#</a> Pipe</h3>
...
<h2 id="selector选择器" tabindex="-1"><a class="header-anchor" href="#selector选择器" aria-hidden="true">#</a> Selector选择器</h2>
<h3 id="选择器基础" tabindex="-1"><a class="header-anchor" href="#选择器基础" aria-hidden="true">#</a> 选择器基础</h3>
...
<h4 id="三个相关的类" tabindex="-1"><a class="header-anchor" href="#三个相关的类" aria-hidden="true">#</a> 三个相关的类</h4>
...
<h4 id="如何建立选择器" tabindex="-1"><a class="header-anchor" href="#如何建立选择器" aria-hidden="true">#</a> 如何建立选择器</h4>
<p>1.创建Selector</p>
...
<h3 id="选择键相关的方法" tabindex="-1"><a class="header-anchor" href="#选择键相关的方法" aria-hidden="true">#</a> 选择键相关的方法</h3>
...
<h3 id="使用选择器" tabindex="-1"><a class="header-anchor" href="#使用选择器" aria-hidden="true">#</a> 使用选择器</h3>
