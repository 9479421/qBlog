<template><h1 id="栈溢出漏洞分析" tabindex="-1"><a class="header-anchor" href="#栈溢出漏洞分析" aria-hidden="true">#</a> 栈溢出漏洞分析</h1>
<blockquote>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br></div></div><p>要求不改动任何代码和汇编指令的情况下，仅通过输入年龄，利用栈溢出漏洞，来实现Hack函数的触发。</p>
<p>先分析，入count()之前一定会存入执行完毕的返回地址入栈，进入count后会申请一片栈区用来存储数组和变量，那么我们只要让age数组溢出到返回地址部位，并将Hack的地址输入进去，就可以实现Hack函数的触发。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917035030810.png" alt="image-20230917035030810"></p>
<p>直接给GetAge()函数下断点，输入数字1，按下回车。</p>
<p>注意力直接锁定栈区，00FDFD9C的值便是记录了执行完count()函数的返回地址，而00FDFD50便是age[]数组的起始位置。</p>
<p>紧接着再依次输入2、3、4、5……</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917035421883.png" alt="image-20230917035421883"></p>
<p>经过对比观察，我们可以发现00FDFD8C记录了下一个age的下标，也就是即将要被修改的位置，因此我们持续输入，将堆栈压到下标处。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917040132060.png" alt="image-20230917040132060"></p>
<p>此时将下标修改为18，随着回车的按下，下标会继续+1，也就是19，此时对应的就是00EFFA94的位置，然后输入Hack的地址，即003B10EB的10进制3870955，再次回车，即可修改掉00EFFA94的值为Hack地址，进而实现栈溢出漏洞。</p>
<p>正当以为成功之时，我们发现程序崩溃了。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917040543833.png" alt="image-20230917040543833"></p>
<p>先说结论，原因出在堆栈平衡被破坏。</p>
<p>于是，我们在do while循环结束后，尝试继续跟进。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917041303509.png" alt=""></p>
<p>可以看到他在函数执行完毕，进入了一个call，先是对栈顶是否为0xCCCCCCCC进行了判定</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917041341424.png" alt="image-20230917041341424"></p>
<p>随后又对第11个元素进行了0xCCCCCCCC的判定。</p>
<p>由此我们可以得出结论，只要在输入第11个数的时候，填入0xCCCCCCCC，也就是十进制的-858993460，就不会引起堆栈平衡的校验而引发崩溃。</p>
<p>最后我们再来一次</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917041751073.png" alt=""></p>
<p>最后输入0，回车，就可以得到Hack后的效果了。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230917042346030.png" alt="image-20230917042346030"></p>
</template>
