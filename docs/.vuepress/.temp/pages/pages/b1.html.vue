<template><div><h1 id="最低成本的方式搭建chatgpt接口" tabindex="-1"><a class="header-anchor" href="#最低成本的方式搭建chatgpt接口"><span>最低成本的方式搭建ChatGpt接口</span></a></h1>
<blockquote>
...
<h2 id="初次试错" tabindex="-1"><a class="header-anchor" href="#初次试错"><span>初次试错</span></a></h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> express <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'express'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与此同时我将本机开启了全局翻墙，但我经过测试接口发现会引发超时错误。</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token literal-property property">Error</span><span class="token operator">:</span> Error<span class="token operator">:</span> connect <span class="token constant">ETIMEDOUT</span> <span class="token number">104.23</span><span class="token number">.125</span><span class="token number">.189</span><span class="token operator">:</span><span class="token number">443</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>于是通过API工具调用接口进行尝试，一样引发了超时错误。</p>
...
<h2 id="步入正轨" tabindex="-1"><a class="header-anchor" href="#步入正轨"><span>步入正轨</span></a></h2>
<p>下面给大家推荐一个终极解决方案</p>
<blockquote>
...
<h3 id="_1-新建云函数" tabindex="-1"><a class="header-anchor" href="#_1-新建云函数"><span>1.新建云函数</span></a></h3>
...
<p>函数代码如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code><span class="token string">'use strict'</span><span class="token punctuation">;</span>
...
<h3 id="_2-安装依赖" tabindex="-1"><a class="header-anchor" href="#_2-安装依赖"><span>2.安装依赖</span></a></h3>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">cd</span> src
<span class="token function">npm</span> <span class="token function">install</span> request
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503145833960.png" alt="image-20230503145833960"></p>
<p>执行完毕后就多出来了一堆依赖文件，至此我们的云函数就算是编写完毕了，点击部署按钮，即可上传云函数成功。</p>
<h3 id="_3-查看访问url" tabindex="-1"><a class="header-anchor" href="#_3-查看访问url"><span>3.查看访问url</span></a></h3>
