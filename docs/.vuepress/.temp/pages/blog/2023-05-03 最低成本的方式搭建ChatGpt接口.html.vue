<template><h1 id="最低成本的方式搭建chatgpt接口" tabindex="-1"><a class="header-anchor" href="#最低成本的方式搭建chatgpt接口" aria-hidden="true">#</a> 最低成本的方式搭建ChatGpt接口</h1>
<blockquote>
...
<h2 id="初次试错" tabindex="-1"><a class="header-anchor" href="#初次试错" aria-hidden="true">#</a> 初次试错</h2>
<p>接下来我们就要对需求进行分析，因为接口必须翻墙才可以访问，所以按照大家惯性思维去搭建这个后端接口的话，都是采用任一编程语言实现一段http接口操作，然后运行到服务器上后，并且给服务器挂上梯子，再通过前端对这个接口进行访问。</p>
<p>于是我便开始了这第一种方法的尝试，这里我使用的是Nodejs语言的Express实现了一个简易的后端接口进行测试。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br></div></div><p>与此同时我将本机开启了全局翻墙，但我经过测试接口发现会引发超时错误。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token literal-property property">Error</span><span class="token operator">:</span> Error<span class="token operator">:</span> connect <span class="token constant">ETIMEDOUT</span> <span class="token number">104.23</span><span class="token number">.125</span><span class="token number">.189</span><span class="token operator">:</span><span class="token number">443</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>于是通过API工具调用接口进行尝试，一样引发了超时错误。</p>
<p>这里可以推测出原因，系统虽然实现了翻墙，但是代码并没有走系统代理，于是我便对API工具设置了系统代理。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503143835318.png" alt="image-20230503143835318"></p>
<p>然后再次访问测试，得到了我想要的结果。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503143959381.png" alt="image-20230503143959381"></p>
<p>知道了原因，那么我们还要想办法对代码实现系统代理，这里就比较复杂了，况且就算实现后，我们还要自备服务器和翻墙软件，然后将其跑在自己的服务器上，成本很高，并且要挂梯子，很复杂，所以我便直接放弃了这个方案。</p>
<h2 id="步入正轨" tabindex="-1"><a class="header-anchor" href="#步入正轨" aria-hidden="true">#</a> 步入正轨</h2>
<p>下面给大家推荐一个终极解决方案</p>
<blockquote>
<p>使用云函数对openai接口进行访问</p>
</blockquote>
<p>知名云计算平台，例如阿里云、腾讯云、华为云，都有云函数的支持，我们只需要将云函数的地区设置到美国或者其他Openai支持的国家，就可以实现免翻墙直接访问接口。</p>
<p>这里要感谢云计算为我们个人开发者或者中小企业带来的便利。
接下来详细的介绍一下云函数的使用方法及代码编写，这里以<strong>腾讯云</strong>为例。</p>
<h3 id="_1-新建云函数" tabindex="-1"><a class="header-anchor" href="#_1-新建云函数" aria-hidden="true">#</a> 1.新建云函数</h3>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503144910978.png" alt="image-20230503144910978"></p>
<p>选择从头开始，运行环境根据自己的编程语言来，这里以Nodejs为例。</p>
<p>函数代码如下：</p>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><p>这样，该云函数就实现了读取question参数并访问openai接口，然后返回chatgpt机器人回复内容的功能。</p>
<p>正常云函数是通过定时触发的，因为我们要通过http主动访问这个云函数，所以要创建一个API网关触发器而不是定时触发器。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503145445929.png" alt="image-20230503145445929"></p>
<p>还有最后一个异常重要的地方要进行设置，因为ChatGpt接口调用有时延，有的时候机器人需要数十秒才可以回应我们的请求，所以要设置超时长一点，这里设置成60s。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503152125364.png" alt="image-20230503152125364"></p>
<p>至此，所有环境配置完毕，点击完成即可。</p>
<h3 id="_2-安装依赖" tabindex="-1"><a class="header-anchor" href="#_2-安装依赖" aria-hidden="true">#</a> 2.安装依赖</h3>
<p>刚刚只是编写了js代码，但是依赖库还没有安装，所以我们要先去安装函数依赖。只用到了request一个包，只需要安装这一个就可以了。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503145614838.png" alt="image-20230503145614838"></p>
<p>首先点击终端-新建终端</p>
<p>我们可以看到index.js在src目录里，所以步骤如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503145833960.png" alt="image-20230503145833960"></p>
<p>执行完毕后就多出来了一堆依赖文件，至此我们的云函数就算是编写完毕了，点击部署按钮，即可上传云函数成功。</p>
<h3 id="_3-查看访问url" tabindex="-1"><a class="header-anchor" href="#_3-查看访问url" aria-hidden="true">#</a> 3.查看访问url</h3>
<p>切换到触发管理界面，找到刚刚我们创建的API网关触发的访问路径，将其复制下来。</p>
<p>https://service-2ruclnmk-1304194722.usw.apigw.tencentcs.com/release/chatgpt</p>
<p>这里要去掉release才是真正的访问路径</p>
<p>https://service-2ruclnmk-1304194722.usw.apigw.tencentcs.com/chatgpt</p>
<p>我们再对question参数进行拼接</p>
<p>https://service-2ruclnmk-1304194722.usw.apigw.tencentcs.com/chatgpt?question=你好，我是帅哥</p>
<p>这里question便是我们自定义的问题了，通过get请求或者直接浏览器访问即可实现chatgpt接口的云函数调用。</p>
<p><img src="https://wqby-1304194722.cos.ap-nanjing.myqcloud.com/img/image-20230503150348750.png" alt="image-20230503150348750"></p>
<p>至此，我们的功能便彻底实现完成。</p>
<p>云函数首次使用应该会赠送免费的使用额度，使用完免费额度后，是按量付费的，成本很低，要记住往腾讯云里充值一些余额，以防欠费后无法调用。</p>
</template>
